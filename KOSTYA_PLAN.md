...
12 seed-интервью (`make reset-data`) перед финальной проверкой пользователем.
Осталось: пользователь проверяет `/interviews` в браузере глазами → финальный
коммит фронтенда → готово к демо.
